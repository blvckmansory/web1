...
const TARIFF_CONFIG: TariffType[] = [
	...
	},
	{
		title: 'Минуты и КМ',
		description: (price) =>
			`Минутные пакеты включают время аренды, а пробег вы регулируете сами. Режим стоянка отдельно не тарифицируется. Стоимость указана уже с учётом скидки.`,
	...
	},
	{
		title: 'Часы и КМ',
		description: (price) =>
			`Часовые абонементы включают время аренды, а пробег вы регулируете сами. Режим стоянка отдельно не тарифицируется. Стоимость указана уже с учётом скидки.`,
		footer: (price) => `Каждый км по ${price} BYN`,
	...
	},
	{
		title: 'Сутки и КМ',
		description: (price) =>
			`Абонементы на сутки включают время аренды, а пробег вы регулируете сами. Режим стоянка отдельно не тарифицируется. Стоимость указана уже с учётом скидки.`,
		footer: (price) => `Каждый км по ${price} BYN`,
